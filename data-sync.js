...
},{"./container":3,"./managers/api":5,"./managers/db":7,"./managers/sync":8,"./utils/assert":9,"./utils/debug":10,"./utils/object":14}],3:[function(require,module,exports){
'use strict';
...
},{"./utils/object":14}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./application":2}],5:[function(require,module,exports){
'use strict';
...
},{"../utils/debug":10,"../utils/is-empty":12,"../utils/is-none":13,"../utils/stringify-query":15,"./base":6}],6:[function(require,module,exports){
'use strict';
...
var DB = function (_Base) {
	...
	_createClass(DB, [{
		...
		value: function put(type, data) {
			...
			dbOpen(this.dbInfo, type, function (cursor) {
				cursor.put(data).then(function () {
					return cb();
				});
			});
		...
		value: function getById(type, id) {
			...
			dbOpen(this.dbInfo, type, function (cursor) {
				cursor.get({ id: id }).then(function (model) {
					return cb(model);
				});
			});
...
function dbOpen(dbInfo, type, cb) {
	...
	db.transaction('rw', db[type], function () {
		cb(db[type]);
	});
}
...
},{"../utils/debug":10,"./base":6,"dexie":1}],8:[function(require,module,exports){
'use strict';
...
},{"../utils/object":14,"./base":6}],9:[function(require,module,exports){
"use strict";
...
},{"./is-none":13}],12:[function(require,module,exports){
'use strict';
...
},{"./is-none":13}],13:[function(require,module,exports){
"use strict";
...
},{"./is-none":13}],15:[function(require,module,exports){
'use strict';
